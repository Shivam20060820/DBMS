...
--
-- Temporary view structure for view `activecases`
--

DROP TABLE IF EXISTS `activecases`;
/*!50001 DROP VIEW IF EXISTS `activecases`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `activecases` AS SELECT 
 1 AS `case_id`,
 1 AS `fir_id`,
 1 AS `judgement`,
 1 AS `case_status`,
...
--
-- Temporary view structure for view `caseoverview`
--

DROP TABLE IF EXISTS `caseoverview`;
/*!50001 DROP VIEW IF EXISTS `caseoverview`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `caseoverview` AS SELECT 
 1 AS `fir_no`,
 1 AS `case_status`,
 1 AS `judgement`,
 1 AS `criminal_name`,
...
INSERT INTO `jail_records` VALUES (501,1,1,'2025-12-02',NULL,180),(502,2,2,'2025-12-06',NULL,365),(503,3,3,'2025-12-12','2025-12-20',30),(900,1,1,'2018-01-01',NULL,100);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `archive_old_records` BEFORE INSERT ON `jail_records` FOR EACH ROW BEGIN
    IF NEW.entry_date <= DATE_SUB(CURDATE(), INTERVAL 5 YEAR) THEN
        
        INSERT INTO jail_records_archive
        VALUES (NEW.record_id, NEW.cri_id, NEW.jail_id, 
                NEW.entry_date, NEW.release_date, NEW.sentence_duration);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_criminal_status` AFTER INSERT ON `jail_records` FOR EACH ROW BEGIN
    UPDATE criminal
    SET status = 'In Jail'
    WHERE cri_id = NEW.cri_id;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
--
-- Table structure for table `jail_records_archive`
--

DROP TABLE IF EXISTS `jail_records_archive`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `jail_records_archive` (
  `record_id` int NOT NULL,
  `cri_id` int DEFAULT NULL,
  `jail_id` int DEFAULT NULL,
  `entry_date` date DEFAULT NULL,
...
--
-- Dumping data for table `jail_records_archive`
--

LOCK TABLES `jail_records_archive` WRITE;
/*!40000 ALTER TABLE `jail_records_archive` DISABLE KEYS */;
INSERT INTO `jail_records_archive` VALUES (900,1,1,'2018-01-01',NULL,100);
/*!40000 ALTER TABLE `jail_records_archive` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GetAge`(dob DATE) RETURNS int
    DETERMINISTIC
BEGIN
    DECLARE age INT;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `GetCaseDuration` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = cp850 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `GetCaseDuration`(fid INT) RETURNS int
    DETERMINISTIC
BEGIN
    DECLARE days INT;

    SELECT DATEDIFF(
        IFNULL(judgement_date, CURDATE()),
        filing_date
    )
    INTO days
    FROM case_details
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `IsRepeatOffender` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = cp850 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `IsRepeatOffender`(cid INT) RETURNS varchar(10) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
    DECLARE total INT;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetCaseDetails` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = cp850 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetCaseDetails`(IN fid INT)
Begin
    SELECT c.case_id, f.fir_no, c.case_status, c.judgement
    FROM case_details c
...
--
-- Final view structure for view `activecases`
--
...
/*!50001 VIEW `activecases` AS select `case_details`.`case_id` AS `case_id`,`case_details`.`fir_id` AS `fir_id`,`case_details`.`judgement` AS `judgement`,`case_details`.`case_status` AS `case_status`,`case_details`.`filing_date` AS `filing_date`,`case_details`.`judgement_date` AS `judgement_date` from `case_details` where (`case_details`.`case_status` = 'Ongoing') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `caseoverview`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `caseoverview` AS select `f`.`fir_no` AS `fir_no`,`c`.`case_status` AS `case_status`,`c`.`judgement` AS `judgement`,`cr`.`name` AS `criminal_name`,`v`.`name` AS `victim_name` from (((`fir` `f` join `case_details` `c` on((`f`.`fir_id` = `c`.`fir_id`))) left join `criminal` `cr` on((`f`.`cri_id` = `cr`.`cri_id`))) left join `victim` `v` on((`f`.`fir_id` = `v`.`fir_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2026-04-06  8:49:58
